            ...
            <div className="col-md-4 col-sm-12 sal-animate" data-sal="slide-up">
              <div className="featured-imagebox featured-imagebox-post style1">
                <div className="featured-thumbnail">
                  <img className="img-fluid" src="/assets/img/boat.jpg" alt="" height="100%" width="100%" />
                </div>
                <div className="featured-content">
                  ...
                  <div className="post-header">
                    ...
                    <div className="post-meta">
                      <a href="#" target="_blank"></a>
                      <a href={"/assets/pdf/MATT.pdf"} target="_blank" rel="noreferrer">
                        {" "}
                  ...
                  <div className="post-title featured-title">
                    <h3>
                      <a href={"/assets/pdf/MATT.pdf"} target="_blank" rel="noreferrer">300x600mm (Matt Finish)</a>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="featured-imagebox featured-imagebox-post style1">
                ...
                <div className="featured-content">
                  ...
                  <div className="post-header">
                    ...
                    <div className="post-meta">
                      <a href="#" target="_blank"></a>
                      <a href="Glossy-Series.pdf" target="_blank">
                        {" "}
                        <span className="ttm-meta-line comments-link">Download</span>
                      </a>
                    </div>
              ...
              <div className="featured-imagebox featured-imagebox-post style1">
                ...
                <div className="featured-content">
                  ...
                  <div className="post-header">
                    ...
                    <div className="post-meta">
                      <a href="#" target="_blank"></a>
                      <a href="Elevation-Series.pdf" target="_blank">
                        {" "}
                        <span className="ttm-meta-line comments-link">Download</span>
                      </a>
                    </div>
              ...
              <div className="featured-imagebox featured-imagebox-post style1">
                ...
                <div className="featured-content">
                  ...
                  <div className="post-header">
                    ...
                    <div className="post-meta">
                      <a href="#" target="_blank"></a>
                      <a href="pdf/QRAX_CERAMIC_ELEVATION.pdf" target="_blank">
                        {" "}
                        <span className="ttm-meta-line comments-link">Download</span>
                      </a>
                    </div>
                  ...
                  <div className="post-title featured-title">
                    <h3>
                      <a href="pdf/QRAX_CERAMIC_ELEVATION.pdf" target="_blank">
                        300x600mm Digital Wall Tiles (Elevation Series)
                      </a>
                    </h3>
                  </div>
                </div>
              ...
              <div className="featured-imagebox featured-imagebox-post style1">
                ...
                <div className="featured-content">
                  ...
                  <div className="post-header">
                    ...
                    <div className="post-meta">
                      <a href="#" target="_blank"></a>
                      <a href="pdf/QRAX_CERAMIC_GLOSSY_VOLUME_01.pdf" target="_blank">
                        {" "}
                        <span className="ttm-meta-line comments-link">Download</span>
                      </a>
                    </div>
                  ...
                  <div className="post-title featured-title">
                    <h3>
                      <a href="pdf/QRAX_CERAMIC_GLOSSY_VOLUME_01.pdf" target="_blank">
                        300x600mm Digital Wall Tiles(Glossy Finish)
                      </a>
                    </h3>
                  </div>
                </div>
              ...
              <div className="featured-imagebox featured-imagebox-post style1">
                ...
                <div className="featured-content">
                  ...
                  <div className="post-header">
                    ...
                    <div className="post-meta">
                      <a href="#" target="_blank"></a>
                      <a href="pdf/QRAX_CERAMIC_GLOSSY_VOLUME_02.pdf" target="_blank">
                        {" "}
                        <span className="ttm-meta-line comments-link">Download</span>
                      </a>
                    </div>
